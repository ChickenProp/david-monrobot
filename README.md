...
Tournament; see the remainder of this README (written by the contest organizer)
for details of that. My bot is named "David MonRoBot" and came joint first; see
DMRB.hs for details about ver (including source). The tournament took place in
2014, but I'm uploading this to github in 2017 because I was recently reminded
of it.
